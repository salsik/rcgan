...
def preprocess_for_training(train_A_dir, train_B_dir, cache_folder):
    ...
    np.savez(os.path.join(cache_folder, 'logf0s_normalizationSF1TM1.npz'),
             mean_A=log_f0s_mean_A,
             std_A=log_f0s_std_A,
             mean_B=log_f0s_mean_B,
             std_B=log_f0s_std_B)

    np.savez(os.path.join(cache_folder, 'mcep_normalizationSF1TM1.npz'),
    ...
    save_pickle(variable=coded_sps_A_norm,
                fileName=os.path.join(cache_folder, "coded_sps_A_normSF1.pickle"))
    save_pickle(variable=coded_sps_B_norm,
                fileName=os.path.join(cache_folder, "coded_sps_B_normTM1.pickle"))
