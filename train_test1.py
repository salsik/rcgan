...
## here we test case 1 in the casese of detach variables
...
class CycleGANTraining:
    def __init__(self,
        ...
        if not os.path.exists(self.output_A_dir):
            os.makedirs(self.output_A_dir)

        if not os.path.exists(self.output_B_dir):
            os.makedirs(self.output_B_dir)

        # Storing Discriminatior and Generator Loss
        self.generator_loss_store = []
        self.discriminator_loss_store = []

        self.file_name = 'log_store_case_1.txt'
    ...
    def train(self):
        ...
        for epoch in range(self.start_epoch, self.num_epochs):
            ...
            # case 0 #
            #0000#  generate again ... and this is the first state and mostly doesn't work
            ...
            # case 1
                ...
                d_fake_A=d_fake_A.cpu().detach()
                d_fake_B=d_fake_B.cpu().detach()
            ...
            if epoch % 100 == 0 and epoch != 0:
                ...
                self.saveModelCheckPoint(epoch, '{}'.format(
                    self.modelCheckpoint + '_CycleGAN_CheckPointSF1TM1_test1'))
                print("Model Saved!")
    ...
    def validation_for_B_dir(self,epoch=100):
        num_mcep = 24
        sampling_rate = 16000
        frame_period = 5.0
        n_frames = 128
...
if __name__ == '__main__':
    ...
    eval_folder = '../data/vcc2016_training/evaluation_all/'
    convert_folder = '../data/vcc2016_training/converted_sound/'

    logf0s_normalization_default = cache_folder + 'logf0s_normalizationSF1TM1.npz'
    mcep_normalization_default = cache_folder +'mcep_normalizationSF1TM1.npz'
    coded_sps_A_norm = cache_folder + 'coded_sps_A_normSF1.pickle'
    coded_sps_B_norm = cache_folder + 'coded_sps_B_normTM1.pickle'
    model_checkpoint = cache_folder + 'model_checkpoint/'
    resume_training_at = cache_folder +  'model_checkpoint/_CycleGAN_CheckPointSF1TM12020'
    resume_training_at = None

    validation_A_dir_default = eval_folder + 'SF1/'
    output_A_dir_default = convert_folder + 'SF1_case1/'

    validation_B_dir_default = eval_folder + 'TM1/'
    output_B_dir_default = convert_folder + 'TM1_case1/'
