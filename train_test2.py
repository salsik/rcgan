...
## here we test case 2 in the casese of detach variables
...
class CycleGANTraining:
    def __init__(self,
        ...
        self.file_name = 'log_store_case_2.txt'
        ...
        for epoch in range(self.start_epoch, self.num_epochs):
            ...
            if epoch % 100 == 0 and epoch != 0:
                ...
                self.saveModelCheckPoint(epoch, '{}'.format(
                    self.modelCheckpoint + '_CycleGAN_CheckPointSF1TM1_test2'))
                print("Model Saved!")
...
if __name__ == '__main__':
    ...
    output_A_dir_default = convert_folder + 'SF1_case2/'

    validation_B_dir_default = eval_folder + 'TM1/'
    output_B_dir_default = convert_folder + 'TM1_case2/'
