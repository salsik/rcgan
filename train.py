    ...
    def train(self):
        ...
        for epoch in range(self.start_epoch, self.num_epochs):
            ...
            for i, (real_A, real_B) in enumerate(train_loader):
                ...
                identity_A123 = self.generator_B2A(real_A)
...
if __name__ == '__main__':
    ...
    validation_B_dir_default = '../data/vcc2016_training/evaluation_all/SM2/'
    output_B_dir_default = '../data/vcc2016_training/converted_sound/SM2/'
